...
export const bookings = [
  ...
  // CABIN 009
  {
    ...
    guestId: 1,
    hasBreakfast: true,
    observations: "Requesting a bottle of champagne upon arrival.",
    isPaid: true,
    numGuests: 2,
  },
  {
  ...
  // CABIN 010
  {
    ...
    guestId: 3,
    hasBreakfast: true,
    observations: "Need accessibility accommodations.",
    isPaid: true,
    numGuests: 1,
  },
  {
  ...
  // CABIN 011
  {
    ...
    guestId: 5,
    hasBreakfast: true,
    observations: "Gluten-free breakfast options requested.",
    isPaid: true,
    numGuests: 2,
  },
  {
  ...
  // CABIN 012
  {
    ...
    guestId: 7,
    hasBreakfast: true,
    observations: "Vegetarian breakfast options requested.",
    isPaid: true,
    numGuests: 2,
  },
  {
    ...
    guestId: 8,
    hasBreakfast: false,
    observations: "Request for extra bedding.",
    isPaid: false,
    numGuests: 4,
  },
  ...
  {
    created_at: fromToday(-22),
    startDate: fromToday(22),
    endDate: fromToday(25),
    cabinId: 13,
    guestId: 10,
    hasBreakfast: false,
    observations: "Allergic to feathers, need hypoallergenic pillows.",
    isPaid: false,
    numGuests: 3,
  },
  ...
  // CABIN 014
  {
    created_at: fromToday(-12),
    startDate: fromToday(4),
    endDate: fromToday(8),
    cabinId: 14,
    guestId: 11,
    hasBreakfast: true,
    observations: "Requesting high-floor cabin for better views.",
    isPaid: true,
    numGuests: 2,
  },
  {
  ...
  // CABIN 015
  {
    created_at: fromToday(-17),
    startDate: fromToday(9),
    endDate: fromToday(12),
    cabinId: 15,
    guestId: 13,
    hasBreakfast: true,
    observations: "Non-smoking cabin requested.",
    isPaid: true,
    numGuests: 3,
  },
  {
    ...
    guestId: 14,
    hasBreakfast: false,
    observations: "Need space for bike storage.",
    isPaid: false,
    numGuests: 2,
  },
  ...
  // CABIN 016
  {
    created_at: fromToday(-9),
    startDate: fromToday(6),
    endDate: fromToday(10),
    cabinId: 16,
    guestId: 15,
    hasBreakfast: true,
    observations: "Would like a cabin close to the lake if possible.",
    isPaid: true,
    numGuests: 3,
  },
  {
    created_at: fromToday(-21),
    startDate: fromToday(17),
    endDate: fromToday(21),
    cabinId: 16,
    guestId: 16,
    hasBreakfast: false,
    observations: "Requesting a quiet cabin far from communal areas.",
    isPaid: false,
    numGuests: 2,
  },
];
