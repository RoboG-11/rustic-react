...
.rdp {
  ...
  --rdp-background-color: var(--color-grey-300);
  --rdp-outline: 2px solid var(--color-yellow-700);
  --rdp-outline-selected: 3px solid var(--color-grey-900);
  --rdp-selected-color: #f9fafb;
 margin: 2rem -0.3rem;
}
